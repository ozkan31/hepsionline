        ...
        <div className="w-full px-4 md:px-8">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 md:gap-4">
              <div ref={searchWrapRef} className="relative hidden lg:flex items-center">
                <form
          ...
          <div className="p-4">
            ...
            <form onSubmit={handleSearch} className="mb-6 flex items-center gap-2">
              <input
                ...
                value={searchQuery}
                onChange={(e) => setSearchQuery(e.target.value)}
                className="flex-1 bg-white border border-gray-200 rounded-full px-4 py-2.5 text-sm outline-none focus:border-black"
              />
              <button
                type="submit"
